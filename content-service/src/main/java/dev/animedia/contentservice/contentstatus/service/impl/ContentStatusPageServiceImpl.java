...
public class ContentStatusPageServiceImpl implements ContentStatusPageService {
	...
	public Page<ContentStatusWithTranslationsResponseDto> search(
		...
		return contentStatusRepository.search(
			searchContentStatusAdminRequestDto.contentStatusIds(),
			searchContentStatusAdminRequestDto.aliases(),
			searchContentStatusAdminRequestDto.languageCodes(),
			searchContentStatusAdminRequestDto.names(),
			searchContentStatusAdminRequestDto.pageable()
		);
	}
}
