package dev.animedia.languageservice.constants;
...
public class LanguageErrorConstants {
    ...
    public static final String LANGUAGE_CODE_NOT_FOUND_MESSAGE = "LANGUAGE_CODE_NOT_FOUND";
    public static final String LANGUAGE_CODES_NOT_FOUND_MESSAGE = "LANGUAGE_CODES_NOT_FOUND";
    ...
    public static final String LANGUAGE_CODE_INVALID_PATTERN_MESSAGE = "LANGUAGE_CODE_INVALID_PATTERN";
