...
public final class ContentStatusTranslationPrivateServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest,
      protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> getCreateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "create",
      requestType = protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest.class,
      responseType = protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest,
      protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest, protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> getCreateMethod;
      ...
      synchronized (ContentStatusTranslationPrivateServiceGrpc.class) {
        if ((getCreateMethod = ContentStatusTranslationPrivateServiceGrpc.getCreateMethod) == null) {
          ContentStatusTranslationPrivateServiceGrpc.getCreateMethod = getCreateMethod =
              io.grpc.MethodDescriptor.<protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest, protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "create"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest,
      protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> getUpdateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "update",
      requestType = protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest.class,
      responseType = protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest,
      protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> getUpdateMethod() {
    io.grpc.MethodDescriptor<protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest, protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> getUpdateMethod;
      ...
      synchronized (ContentStatusTranslationPrivateServiceGrpc.class) {
        if ((getUpdateMethod = ContentStatusTranslationPrivateServiceGrpc.getUpdateMethod) == null) {
          ContentStatusTranslationPrivateServiceGrpc.getUpdateMethod = getUpdateMethod =
              io.grpc.MethodDescriptor.<protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest, protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "update"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest,
      dev.animedia.grpc.common.CommonProto.EmptyResponse> getDeleteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "delete",
      requestType = protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest.class,
      responseType = dev.animedia.grpc.common.CommonProto.EmptyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest,
      dev.animedia.grpc.common.CommonProto.EmptyResponse> getDeleteMethod() {
    io.grpc.MethodDescriptor<protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest, dev.animedia.grpc.common.CommonProto.EmptyResponse> getDeleteMethod;
      ...
      synchronized (ContentStatusTranslationPrivateServiceGrpc.class) {
        if ((getDeleteMethod = ContentStatusTranslationPrivateServiceGrpc.getDeleteMethod) == null) {
          ContentStatusTranslationPrivateServiceGrpc.getDeleteMethod = getDeleteMethod =
              io.grpc.MethodDescriptor.<protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest, dev.animedia.grpc.common.CommonProto.EmptyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "delete"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void create(protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest request,
        io.grpc.stub.StreamObserver<protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateMethod(), responseObserver);
    }

    /**
     */
    default void update(protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest request,
        io.grpc.stub.StreamObserver<protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> responseObserver) {
    ...
    /**
     */
    default void delete(protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest request,
  ...
  public static final class ContentStatusTranslationPrivateServiceStub
    ...
    /**
     */
    public void create(protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest request,
        io.grpc.stub.StreamObserver<protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> responseObserver) {
    ...
    /**
     */
    public void update(protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest request,
        io.grpc.stub.StreamObserver<protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
    ...
    /**
     */
    public void delete(protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest request,
        io.grpc.stub.StreamObserver<dev.animedia.grpc.common.CommonProto.EmptyResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ContentStatusTranslationPrivateServiceBlockingV2Stub
    ...
    /**
     */
    public protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse create(protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest request) throws io.grpc.StatusException {
    ...
    /**
     */
    public protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse update(protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
    ...
    /**
     */
    public dev.animedia.grpc.common.CommonProto.EmptyResponse delete(protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
  ...
  public static final class ContentStatusTranslationPrivateServiceBlockingStub
    ...
    /**
     */
    public protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse create(protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest request) {
    ...
    /**
     */
    public protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse update(protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getUpdateMethod(), getCallOptions(), request);
    }
    ...
    /**
     */
    public dev.animedia.grpc.common.CommonProto.EmptyResponse delete(protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getDeleteMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class ContentStatusTranslationPrivateServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> create(
        protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse> update(
        protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<dev.animedia.grpc.common.CommonProto.EmptyResponse> delete(
        protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE:
          serviceImpl.create((protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest) request,
              (io.grpc.stub.StreamObserver<protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse>) responseObserver);
          break;
        case METHODID_UPDATE:
          serviceImpl.update((protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest) request,
              (io.grpc.stub.StreamObserver<protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse>) responseObserver);
          break;
        case METHODID_DELETE:
          serviceImpl.delete((protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest) request,
              (io.grpc.stub.StreamObserver<dev.animedia.grpc.common.CommonProto.EmptyResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              protos.services.content.status.ContentStatusTranslationPrivate.CreateRequest,
              protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse>(
                service, METHODID_CREATE)))
        .addMethod(
          getUpdateMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              protos.services.content.status.ContentStatusTranslationPrivate.UpdateRequest,
              protos.services.content.status.ContentStatusCommon.ContentStatusTranslationResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              protos.services.content.status.ContentStatusTranslationPrivate.DeleteRequest,
  ...
  private static abstract class ContentStatusTranslationPrivateServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return protos.services.content.status.ContentStatusTranslationPrivate.getDescriptor();
    }
