...
public final class ContentStatusPublicServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest,
      dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse> getSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "search",
      requestType = dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest.class,
      responseType = dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest,
      dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse> getSearchMethod() {
    io.grpc.MethodDescriptor<dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest, dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse> getSearchMethod;
      ...
      synchronized (ContentStatusPublicServiceGrpc.class) {
        if ((getSearchMethod = ContentStatusPublicServiceGrpc.getSearchMethod) == null) {
          ContentStatusPublicServiceGrpc.getSearchMethod = getSearchMethod =
              io.grpc.MethodDescriptor.<dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest, dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "search"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void search(dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest request,
        io.grpc.stub.StreamObserver<dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse> responseObserver) {
  ...
  public static final class ContentStatusPublicServiceStub
    ...
    /**
     */
    public void search(dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest request,
        io.grpc.stub.StreamObserver<dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse> responseObserver) {
  ...
  public static final class ContentStatusPublicServiceBlockingV2Stub
    ...
    /**
     */
    public dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse search(dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest request) throws io.grpc.StatusException {
  ...
  public static final class ContentStatusPublicServiceBlockingStub
    ...
    /**
     */
    public dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse search(dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest request) {
  ...
  public static final class ContentStatusPublicServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse> search(
        dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest) request,
              (io.grpc.stub.StreamObserver<dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              dev.animedia.grpc.status.ContentStatusPublicProto.SearchRequest,
              dev.animedia.grpc.status.ContentStatusPublicProto.SearchResponse>(
  ...
  private static abstract class ContentStatusPublicServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return dev.animedia.grpc.status.ContentStatusPublicProto.getDescriptor();
    }
