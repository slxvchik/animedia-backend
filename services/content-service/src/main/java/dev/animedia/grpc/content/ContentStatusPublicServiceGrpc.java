...
public final class ContentStatusPublicServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest,
      dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse> getSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "search",
      requestType = dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest.class,
      responseType = dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest,
      dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse> getSearchMethod() {
    io.grpc.MethodDescriptor<dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest, dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse> getSearchMethod;
      ...
      synchronized (ContentStatusPublicServiceGrpc.class) {
        if ((getSearchMethod = ContentStatusPublicServiceGrpc.getSearchMethod) == null) {
          ContentStatusPublicServiceGrpc.getSearchMethod = getSearchMethod =
              io.grpc.MethodDescriptor.<dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest, dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "search"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void search(dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest request,
        io.grpc.stub.StreamObserver<dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse> responseObserver) {
  ...
  public static final class ContentStatusPublicServiceStub
    ...
    /**
     */
    public void search(dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest request,
        io.grpc.stub.StreamObserver<dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse> responseObserver) {
  ...
  public static final class ContentStatusPublicServiceBlockingV2Stub
    ...
    /**
     */
    public dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse search(dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest request) throws io.grpc.StatusException {
  ...
  public static final class ContentStatusPublicServiceBlockingStub
    ...
    /**
     */
    public dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse search(dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest request) {
  ...
  public static final class ContentStatusPublicServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse> search(
        dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest) request,
              (io.grpc.stub.StreamObserver<dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              dev.animedia.grpc.content.ContentStatusPublicProto.SearchRequest,
              dev.animedia.grpc.content.ContentStatusPublicProto.SearchResponse>(
  ...
  private static abstract class ContentStatusPublicServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return dev.animedia.grpc.content.ContentStatusPublicProto.getDescriptor();
    }
