...
public class GrpcGenreMapper {
    ...
    public GenrePrivateProto.SearchResponse toSearchResponse(List<GenreWithTranslationsResponseDto> genresWithTranslations, CommonProto.PaginationResponse pagination) {
        ...
        return GenrePrivateProto.SearchResponse.newBuilder()
            .addAllGenresWithTranslations(genres)
            .build();
    }
