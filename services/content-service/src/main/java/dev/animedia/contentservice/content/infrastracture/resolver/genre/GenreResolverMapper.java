...
public class GenreResolverMapper {
	public GenreDto toContentGenreDto(dev.animedia.contentservice.genre.application.dto.GenreDto genreDto) {
	...
	public GenreTranslationDto toContentGenreTranslationDto(dev.animedia.contentservice.genre.application.dto.GenreTranslationDto genreTranslationDto) {
